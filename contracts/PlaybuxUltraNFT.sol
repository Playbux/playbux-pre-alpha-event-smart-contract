...
contract PlaybuxUltraNFT is ERC721, ERC721Enumerable, ERC2981, AccessControl {
    ...
    constructor(address _receiver, uint96 _feeNumerator, string memory _uri) ERC721("Playbux Ultra", "PBU") {
        baseURI = _uri;
